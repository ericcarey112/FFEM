...
namespace InputOutput
{
    ...
    public class OutputFile
    {
        ...
        {
            // Inputs
            double[] HomogStrain = assembly.HomogenizedStrain;
            double[] HomogStress = assembly.HomogenizedStress;
            Matrix HomogStiff = assembly.HomogenizedStiffness;
            int LoadStep = solver.LoadStepNumber;
            int Attempts = solver.AttemptCounter;
            int NRCount = solver.NRCounter;
            ...
            // Solver info
            Data.Add(LoadStep); // Load step number
            Data.Add(Attempts); // Attempt counter
            Data.Add(NRCount);  // Newton-Raphson iterations
